...
(function () {
  ...
  document.addEventListener('click', function (e) {
    ...
    /* Buy Now shares .product-form__submit for styling but runs its OWN
       clear->add->Razorpay-checkout flow — never route it through add-to-cart */
    if (btn.classList.contains('aa-buy-now-btn') || btn.hasAttribute('data-rzp-magic-checkout')) return;
