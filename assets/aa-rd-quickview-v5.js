...
(function () {
  ...
  function buyNow(modal,variant,btn){
    ...
    try{ if(window.amplitude) window.amplitude.track('Web_Shopify_Buy_Now_Clicked',{'[Amplitude] Product Variant ID':variant.id,'[Amplitude] Product Price':(variant.price||0)/100,'Source':'quickview'}); }catch(e){}
